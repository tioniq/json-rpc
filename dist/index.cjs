...
var EventTracerImpl = class {
  constructor(timeProvider) {
    __publicField(this, "_onStart", new import_eventiq.EventSafeDispatcher());
    __publicField(this, "_onEnd", new import_eventiq.EventSafeDispatcher());
...
var RpcMessageReceiver = class extends import_disposiq.Disposable {
  constructor(options) {
    super();
    __publicField(this, "_channel");
    __publicField(this, "_checkIncomingVersion");
    __publicField(this, "_deserializer");
    __publicField(this, "_onParseMessageFailed", new import_eventiq2.EventDispatcher());
    __publicField(this, "_onInvalidRequest", new import_eventiq2.EventDispatcher());
    __publicField(this, "_onGeneralError", new import_eventiq2.EventDispatcher());
    __publicField(this, "_onRequestError", new import_eventiq2.EventDispatcher());
    __publicField(this, "_onNotification", new import_eventiq2.EventDispatcher());
    __publicField(this, "_onRequest", new import_eventiq2.EventDispatcher());
    __publicField(this, "_onResponse", new import_eventiq2.EventDispatcher());
    this._channel = options.channel;
...
var Peer = class {
  constructor(channel, options) {
     ...
     * @internal
     */
    __publicField(this, "_disposables", new import_disposiq2.DisposableStore());
    /**
     * @internal
     */
    __publicField(this, "_onClose", new import_eventiq3.EventDispatcher());
    /**
     * @internal
     */
    __publicField(this, "_onOpen", new import_eventiq3.EventDispatcher());
    /**
     * @internal
     */
    __publicField(this, "_onGeneralError", new import_eventiq3.EventDispatcher());
    /**
     * @internal
     */
  ...
  onNotification(method) {
    ...
    if (dispatcher === void 0) {
      dispatcher = new import_eventiq3.EventDispatcher();
  ...
  setRequestHandler(method, handler) {
    ...
    return new import_disposiq2.DisposableAction(() => {
